...
interface GetStarredOrdersAdminProps {
    page?: number;
    pageSize?: number;
    searchQuery?: string;
...
export const getStarredOrdersAdmin = async ({
    page = 1,
    pageSize = 10,
    searchQuery = '',
    statusFilter = '',
    ...
    try {
        ...
        console.error('Error fetching starred orders:', error);
